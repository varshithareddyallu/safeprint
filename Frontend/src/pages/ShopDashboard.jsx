...
/* ─── Status config ───────────────────────────────────────────── */
const STATUS_CONFIG = {
  free:     { dot: 'bg-emerald-500', badge: 'bg-emerald-50 text-emerald-700 border-emerald-200', btn: 'border-emerald-400 bg-emerald-50 text-emerald-700 shadow-emerald-100', icon: <CheckCircle2 size={14} />, hint: 'Attracting customers with 10% discount' },
